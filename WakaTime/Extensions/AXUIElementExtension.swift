...
extension AXUIElement {
    ...
    func title(for app: MonitoredApp) -> String? {
        ...
        switch app {
            ...
            case .warp, .slack, .safari, .imessage, .whatsapp, .zoom, .notion, .msoutlook,
                .msexcel, .msteams, .adobexd, .adobeillustrator, .linear, .iterm, .rstudio, .premier, .premierbeta:
            ...
            case .edgebrowser:
                return commonGuard(appName: "Edge")
            }
    }
